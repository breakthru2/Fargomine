...
<input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id'];?>">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="example-email">User BTC account</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" value="<?php echo $_SESSION['block_chain'];?>" name="admin_btc" readonly>
        ...
        <div class="col-sm-10">
            <input type="text" id="roi" name="roi" class="form-control" placeholder="Return amount" hidden >
        </div>
            <span class="err" ><?php if (isset($err['roi'])   ) {
                echo $err['roi'];
            } ?></span>
<!-- 
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="submit" id="example-email" name="submit" class="form-control btn btn-primary" placeholder="Subject" value="Withdraw">
        </div>
    </div>
...
<?php if (isset($msg)) {?>
<script>
swal("Success", "Your withdrawn amount will reflect in your e-wallet within 48 hours","success");
</script>
<?php } ?> 
