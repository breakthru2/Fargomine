...
if (isset($_GET['post_id'])) {
	...
	$response = fetch_single_post($post_id);
if ($response !== false) {
$post = $response;
} 
} else {
		...
		<div class="" style="width: 100%;" >
			<form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Post Title" style="margin-top: 10px;" name="title" value="<?php echo $post['title']; ?>">
				...
				<div class="form-group">
					<select class="custom-select" name="category" id="">
						<option value="<?php echo $post['cat_id']; ?>" selected><?php echo $post['category']; ?></option>
						<?php
				...
				<div class="form-group">
					<textarea name="body" id="" class="form-control"  placeholder="Enter body of post here..." style="width: 100%;resize: none;height: 300px;"><?php echo $post['body']; ?></textarea>
